...
- **Unit File Path:** `/home/ec2-user/.config/systemd/user/hermes-gateway.service`
- **Override File:** An override is present at `/home/ec2-user/.config/systemd/user/hermes-gateway.service.d/override.conf`.
...
WorkingDirectory=/home/ec2-user/.hermes
Environment="HERMES_HOME=/home/ec2-user/.hermes"
EnvironmentFile=-/home/ec2-user/.hermes/.env
Restart=always
RestartSec=5
...
- **ExecStart:** The gateway is run from a Python virtual environment in `/home/ec2-user/hermes-agent/venv/`.
- **WorkingDirectory:** The working directory is `/home/ec2-user/.hermes`.
- **Environment:** The service loads environment variables from `/home/ec2-user/.hermes/.env` (if it exists).
...
- **Canonical Installation Directory:**
  - `/home/ec2-user/hermes-agent/` (Contains the application code and Python venv)
- **Canonical Python Virtual Environment:**
  - `/home/ec2-user/hermes-agent/venv/`
- **Authoritative Configuration Directory:**
  - `/home/ec2-user/.hermes/` (Working directory, `HERMES_HOME`, and location of the `.env` file)
...
- **Obsolete Files/Directories:**
  - **Docker Compose File:** The file at `/home/ec2-user/hermes-agent/docker-compose.yml` which defines the conflicting Docker services.
...
- **Cleanup Opportunities (To be run in a future maintenance session):**
  1.  **Remove the Docker Compose file:** `rm /home/ec2-user/hermes-agent/docker-compose.yml`
