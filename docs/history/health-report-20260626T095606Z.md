...
- Generated at: `2026-06-26T09:56:06.023725+00:00`
- Overall: `degraded`
...
- **Disk usage**: `76%` — 76% used on /opt/data/home/control-plane
  - Details: `{"available_bytes": 20611407872, "exit_code": 0, "filesystem": "/dev/nvme0n1p1", "mountpoint": "/", "size_bytes": 85819633664, "stderr": "", "target": "/opt/data/home/control-plane", "timed_out": false, "used_bytes": 65208225792, "used_percent": 76}`
- **Memory**: `66%` — 66% memory used
  - Details: `{"available_bytes": 689074176, "total_bytes": 2006237184, "used_bytes": 1317163008, "used_percent": 66}`
- **Swap**: `47%` — 47% swap used
  - Details: `{"free_bytes": 2284408832, "total_bytes": 4294963200, "used_bytes": 2010554368, "used_percent": 47}`
...
- **Current uptime**: `available` — 13d 1h 46m
  - Details: `{"uptime_human": "13d 1h 46m", "uptime_seconds": 1129617}`
- **Current load average**: `available` — 0.09, 0.08, 0.07
  - Details: `{"load_average": [0.09, 0.08, 0.07]}`
- **Current timestamp**: `available` — 2026-06-26T09:56:06.023703+00:00
  - Details: `{"timestamp": "2026-06-26T09:56:06.023703+00:00"}`
